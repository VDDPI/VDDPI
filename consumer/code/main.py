...
def process_data(person_1, person_2, person_3, person_4, person_5):
    person_arr = [person_1, person_2, person_3, person_4, person_5]
    rounded = {}
    for p in person_arr:
        try:
            rounded[p["age"] // 10 * 10] += 1
        except KeyError:
            rounded[p["age"] // 10 * 10] = 1
    return plib.get_maxKey(rounded)
...
"""
    ...
    TRUSTED_TIME_API_URL = "https://192.168.220.5:8005/time"
...
"""
    CERT_PATH = "./certs/api_ca_cert.pem"
    TRUSTED_GEOLOCATION_API_URL = "https://192.168.220.5:8005/location"
