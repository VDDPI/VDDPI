...
VDDPI_EVAL_DIR=$VDDPI_BENCH_DIR/eval_02.d
...
DATA_PROCESSING_CODE="$VDDPI_DIR/docker/gramine_consumer/code_eval_02/main.py"
...
echo "Starting benchmark for eval_02 at $START_TIME"
