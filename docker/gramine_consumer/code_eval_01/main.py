...
def process_data(person_1):
    # Type of Barriers (0/1)
    # ============================================================
    #   ABCDE
    #   ||||+-- Mobility Impairment     (move)
    #   |||+--- Invisible Disability    (move)
    ...
    if person_1["age"] < 6:
        generation = "child"
    elif person_1["age"] < 60:
        generation = "adult"
    else:
        generation = "senior"

    result = f"barrier:{barrier},position:{position},generation:{generation}"
